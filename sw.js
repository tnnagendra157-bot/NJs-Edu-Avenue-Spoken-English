const CACHE='nj-edu-avenue-v4';
const ASSETS=['./','./index.html','./style.css','./manifest.webmanifest','./app.js','./home-enhancements.js','./advanced-features.js','./all-features.js','./features.js'];

const CACHE='nj-edu-avenue-v5';
const ASSETS=['./','./index.html','./style.css','./manifest.webmanifest','./app.js','./home-enhancements.js','./advanced-features.js','./all-features.js','./features.js','./feature-upgrade.js'];
